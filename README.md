...
- **100% Self-Contained Solo Mining:** Bundles the official **Rusty Kaspad Full Node**, the **Rusty Kaspa Stratum Bridge v2.0.1**, and a **Modern High-Performance Management Suite** in a single one-click app (zero external dependencies).
